...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserstartLoginLoginComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserstartSignupSignupComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _userstart_login_login_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./userstart/login/login.component */
    "./src/app/userstart/login/login.component.ts");
    /* harmony import */


    var _userstart_signup_signup_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./userstart/signup/signup.component */
    ...
    var routes = [{
      ...
      path: 'login',
      component: _userstart_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"]
    }, {
      path: 'signup',
      component: _userstart_signup_signup_component__WEBPACK_IMPORTED_MODULE_5__["SignupComponent"]
    }, {
      path: 'user',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _userstart_login_login_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./userstart/login/login.component */
    "./src/app/userstart/login/login.component.ts");
    /* harmony import */


    var _userstart_signup_signup_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./userstart/signup/signup.component */
    "./src/app/userstart/signup/signup.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_6__["HomeComponent"], _userstart_login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"], _userstart_signup_signup_component__WEBPACK_IMPORTED_MODULE_8__["SignupComponent"], _user_user_component__WEBPACK_IMPORTED_MODULE_11__["UserComponent"], _profile_profile_component__WEBPACK_IMPORTED_MODULE_13__["ProfileComponent"]],
      imports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_12__["HttpClientModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatCardModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatToolbarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatExpansionModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_15__["CommonModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_14__["ToastrModule"].forRoot(), ng2_file_upload__WEBPACK_IMPORTED_MODULE_16__["FileUploadModule"]],
      providers: [],
  ...
  function srcAppProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ProfileComponent(router, postObj, http) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.http.post("http://localhost:3000/api/myposts", this.username).subscribe(function (data) {
            _this.posts = data;

            if (_this.posts.posts[0] != undefined) {
              if (_this.posts.posts[0].photos.length == 0) {
                _this.noOfPosts = 0;
              } else {
                _this.pfstatus = false;
                _this.imgUrl = _this.posts.posts[0].photos;
                _this.noOfPosts = _this.imgUrl.length;
                _this.postStatus = false;
              }
            }
          });
          this.http.get("http://localhost:3000/api/myFriends/" + this.user).subscribe(function (data) {
            _this.friends = data;
            _this.names = _this.friends.users[0].friends;

            for (var k = 0; k < _this.names.length; k++) {
              if (_this.names[k] == _this.user) {
                _this.names.splice(k, 1);
              }
            }

            _this.noOfFriends = _this.names.length;
          });
        }
      }, {
        key: "clearLocal",
        ...
        key: "give",
        value: function give(index) {
          var _this2 = this;

          this.path = index.path;
          var p = this.path.substring(22, this.path.length);
          this.http.get("http://localhost:3000/api/getLikes/" + p).subscribe(function (data) {
            _this2.likeInfo = data;

            if (_this2.likeInfo.data[0] != undefined) {
              _this2.like = _this2.likeInfo.data[0].likes;
            } else {
              _this2.like = 0;
            }
          });
          this.http.get("http://localhost:3000/api/getLikes/" + p).subscribe(function (data) {
            _this2.commentInfo = data;

            if (_this2.commentInfo.data[0] != undefined) {
              _this2.noOfComments = _this2.commentInfo.data[0].comments.length;
            } else {
              _this2.noOfComments = 0;
            }
          });
        }
      }, {
        key: "removeFriend",
        value: function removeFriend(obj, index) {
          ...
          this.http.post("http://localhost:3000/api/removefriends/" + obj, this.username).subscribe(function (data) {
            console.log(data);
          });
        ...
        key: "deleteImage",
        value: function deleteImage(path) {
          var index = this.imgUrl.map(function (item) {
            return item.path;
          }).indexOf(path);
          ...
          this.http.post("http://localhost:3000/api/removePost/" + this.user, obj).subscribe(function (data) {
            console.log(data);
          });
  ...
  function srcAppUserUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _userdata_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../userdata.service */
    "./src/app/userdata.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function UserComponent(apiservice, toastr, router, http) {
        var _this3 = this;
        ...
        this.http.get("http://localhost:3000/api/Users/").subscribe(function (data) {
          ...
          _this3.username1 = user;
          _this3.users = data;
          _this3.username = _this3.users.users;

          for (var k = 0; k < _this3.username.length; k++) {
            if (_this3.username[k].username == _this3.username1) {
              _this3.username.splice(k, 1);
            }
          }

          if (_this3.username.length == 0) {
            _this3.addingFriendStatus = true;
          } else {
            _this3.addingFriendStatus = false;
          }

          for (var k = 0; k < _this3.username.length; k++) {
            _this3.friendStatus[k] = true;
          }
        });
      }
      ...
      _createClass(UserComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (!localStorage.getItem("reload")) {
            ...
            this.http.get("http://localhost:3000/api/myfeed/" + this.user).subscribe(function (data) {
              _this4.feed = data;
              _this4.feedPath = _this4.feed.users;
              console.log(_this4.feedPath);

              if (_this4.feedPath.length == 0) {
                _this4.feedStatus = true;
              } else if (_this4.feedPath[0].photos.length == 0 && _this4.feedPath.length == 1) {
                _this4.feedStatus = true;
              } else {
                _this4.feedStatus = false;
              }

              for (var i = 0; i < _this4.feedPath.length; i++) {
                for (var j = 0; j < _this4.feedPath[i].photos.length; j++) {
                  _this4.likesChecking.set(_this4.feedPath[i].photos[j].path, true);
                }
              }

              for (var i = 0; i < _this4.feedPath.length; i++) {
                var _loop = function _loop() {
                  var l = _this4.feedPath[i].photos[j].path;

                  _this4.likesChecking.set(_this4.feedPath[i].photos[j].path, true);

                  var p = _this4.feedPath[i].photos[j].path.substring(22, _this4.feedPath[i].photos[j].path.length);

                  _this4.http.get("http://localhost:3000/api/getLikes/" + p).subscribe(function (data) {
                    _this4.likeInfo = data;

                    if (_this4.likeInfo.data[0] != undefined) {
                      if (_this4.likeInfo.data[0].likedBy.indexOf(_this4.username1) !== -1) {
                        _this4.likesChecking.set(l, false);
                      }
                    }
                  });
                };
          ...
          this.apiservice.getBooks().subscribe(function (data) {
            _this4.make = data;
          });
          ...
          this.uploader.onAfterAddingFile = function (file) {
            ...
            if (_this4.uploader.queue.length > 1) {
              _this4.uploader.removeFromQueue(_this4.uploader.queue[0]);
            }
          };
        }
      }, {
        ...
        value: function onSelectFile(event) {
          ...
          if (event.target.files && event.target.files[0]) {
            ...
            reader.onload = function (imgsrc) {
              _this5.url = imgsrc.target.result;
              _this5.recentURL = _this5.url;
            };
          }
        }
      }, {
        ...
        key: "addFriend",
        value: function addFriend(obj, index) {
          var _this6 = this;

          this.friendStatus[index] = false;
          this.http.post("http://localhost:3000/api/myfriends/" + this.username1, obj).subscribe(function (data) {
            _this6.al = data;

            _this6.http.get("http://localhost:3000/api/myfeed/" + _this6.user).subscribe(function (data) {
              _this6.feed = data;

              _this6.feedPath.splice(0, _this6.feedPath.length);

              _this6.feedPath = _this6.feed.users;
              _this6.recent = false;

              for (var i = 0; i < _this6.feedPath.length; i++) {
                for (var j = 0; j < _this6.feedPath[i].photos.length; j++) {
                  _this6.likesChecking.set(_this6.feedPath[i].photos[j].path, true);
                }
              }

              for (var i = 0; i < _this6.feedPath.length; i++) {
                var _loop2 = function _loop2() {
                  var l = _this6.feedPath[i].photos[j].path;

                  _this6.likesChecking.set(_this6.feedPath[i].photos[j].path, true);

                  var p = _this6.feedPath[i].photos[j].path.substring(22, _this6.feedPath[i].photos[j].path.length);

                  _this6.http.get("http://localhost:3000/api/getLikes/" + p).subscribe(function (data) {
                    _this6.likeInfo = data;

                    if (_this6.likeInfo.data[0] != undefined) {
                      if (_this6.likeInfo.data[0].likedBy.indexOf(_this6.username1) !== -1) {
                        _this6.likesChecking.set(l, false);
                      }
                    }
                  });
                };
              ...
              if (_this6.feedPath.length == 0) {
                _this6.feedStatus = true;
              } else {
                _this6.feedStatus = false;
              }
            });

            alert(_this6.al.message);
          });
        }
      }, {
        key: "liked",
        value: function liked(path) {
          this.obj = {
            "path": path
          };
          ...
          if (this.likesChecking.get(path) == true) {
            ...
            this.http.post("http://localhost:3000/api/like/" + this.username1, this.obj).subscribe(function (data) {
              console.log(data);
            });
          } else {
            this.likesChecking.set(path, true);
            this.http.post("http://localhost:3000/api/disLike/" + this.username1, this.obj).subscribe(function (data) {
              console.log(data);
            });
          }
        }
        ...
        key: "getNames",
        value: function getNames(path) {
          var _this7 = this;

          var p = path.substring(22, path.length);
          this.http.get("http://localhost:3000/api/getLikes/" + p).subscribe(function (data) {
            _this7.likeByInfo = data;

            if (_this7.likeByInfo.data[0] != undefined) {
              _this7.likes = _this7.likeByInfo.data[0].likes;
              _this7.likedBy = _this7.likeByInfo.data[0].likedBy;
            }
          });
        }
      }, {
        key: "sendPath",
        value: function sendPath(path) {
        ...
        value: function addComment() {
          ...
          this.http.post("http://localhost:3000/api/getComments/", this.commentObj).subscribe(function (data) {
            _this8.commentStatus = data;
            alert(_this8.commentStatus.message);
            _this8.commentText = "";
          });
        }
      }, {
        key: "viewComment",
        value: function viewComment(path, name) {
          var _this9 = this;
          ...
          this.http.get("http://localhost:3000/api/getLikes/" + this.forCommentPath).subscribe(function (data) {
            _this9.commentInfo = data;

            if (_this9.commentInfo.data[0].comments.length > 0) {
              _this9.noOfComments = _this9.commentInfo.data[0].comments.length;
              _this9.commentData = _this9.commentInfo.data[0].comments;
            } else {
              _this9.noOfComments = 0;
              _this9.commentData = [];
            }
          });
        }
        ...
        key: "deleteComment",
        value: function deleteComment(obj, index) {
          this.commentData.splice(index, 1);
          this.noOfComments = this.commentData.length;
          this.http.post("http://localhost:3000/api/deleteComment/" + index + "/" + this.forCommentPath, obj).subscribe(function (data) {
            console.log(data);
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(UserdataService, [{
        ...
        value: function getBooks() {
          return this.http.get("".concat(this._postsURL));
        }
      }]);
  ...
  /***/
  function srcAppUserstartLoginLoginComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserstartLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _userdata_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../userdata.service */
    "./src/app/userdata.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(router, myobj, http) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onAddPost(form) {
          ...
          this.http.post('http://localhost:3000/api/users', post).subscribe(function (responseData) {
            if (responseData.message == 1) {
              _this10.b = responseData;
              localStorage.setItem("loginToken", JSON.stringify(_this10.b.posts.username));

              _this10.router.navigate(["/user"]);
            } else if (responseData.message == 0) {
              console.log("Error");
              _this10.log = "Username or Password Invalid";
            }
          });
          form.resetForm();
        }
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/userstart/login/login.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./login.component.css */
      "./src/app/userstart/login/login.component.css")).default]
    })], LoginComponent);
    /***/
  },
  ...
  /***/
  function srcAppUserstartSignupSignupComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserstartSignupSignupComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(SignupComponent, [{
        ...
        value: function onAddPost(form) {
          ...
          this.http.post('http://localhost:3000/api/newuser', this.usernew).subscribe(function (responseData) {
            _this11.data = responseData;

            if (_this11.data.message) {
              _this11.error = '';

              _this11.router.navigate(["/login"]);
            } else {
              _this11.error = "UserName Already Exists.Please try another one. . . .";
            }
          });
          form.resetForm();
        }
    ...
    SignupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/userstart/signup/signup.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./signup.component.css */
      "./src/app/userstart/signup/signup.component.css")).default]
    })], SignupComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\sahil\OneDrive\Desktop\final\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
